...
namespace DanaOz.BLL.Services
{
    public class OnboardingService
    {
        ...
        private static string SubjectQuestion() =>
            ...
            "31 - אזרחות\n" +
            "32 - גיאוגרפיה\n\n" +
            "כתוב/י את שם המקצוע או מספר.\n" +
            "אם את/ה מלמד/ת כמה מקצועות, כתוב/י כמה מספרים.\n" +
            "למשל: \"20 21\" לאנגלית ועברית.\n\n" +
            "אם המקצוע שלך לא מופיע ברשימה, פשוט כתוב/י את שמו ואנחנו נזהה אותו.";
